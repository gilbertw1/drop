...
pub fn create_drop_cli_app() -> App<'static,'static> {
  App::new("drop")
    ...
    .arg(Arg::with_name("mouse")
         ...
         .long("mouse")
         .value_name("BOOL")
         .help("Show mouse cursor in screencast. (Linux only)")
         .takes_value(true)
         .possible_values(&["true", "false"])
         .default_value("false"))
    ...
    .arg(Arg::with_name("stop-key")
         ...
         .help("Keybinding used to stop recording, eg. <ctrl><alt>q")
         .takes_value(true))
    .arg(Arg::with_name("screenshot")
         .short("s")
         .long("screenshot")
         .help("Capture screenshot"))
    .arg(Arg::with_name("tray-icon")
         .long("tray-icon")
         .short("-i")
         .value_name("BOOL")
         .help("Enable tray icon while recording")
         .takes_value(true))
